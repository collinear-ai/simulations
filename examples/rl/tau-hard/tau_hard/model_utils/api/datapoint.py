...
import tau_hard.model_utils
from tau_hard.model_utils.api._model_methods import MODEL_METHODS
from tau_hard.model_utils.api.exception import APIError
from tau_hard.model_utils.api.types import PartialObj
from tau_hard.model_utils.model.exception import ModelError
...
class Datapoint(BaseModel, abc.ABC):
    ...
    @abc.abstractmethod
    def evaluate(self, api: tau_hard.model_utils.API) -> EvaluationResult:
...
class GenerateDatapoint(Datapoint):
    ...
    def evaluate(self, api: tau_hard.model_utils.API) -> tau_hard.model_utils.EvaluationResult:
        raise NotImplementedError
