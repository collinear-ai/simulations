...
from tau_hard.model_utils.api._model_methods import MODEL_METHODS
from tau_hard.model_utils.api.cache import cache_call_w_dedup
from tau_hard.model_utils.api.datapoint import (
...
from tau_hard.model_utils.api.logging import log_call
from tau_hard.model_utils.api.router import RequestRouter, default_request_router
...
from tau_hard.model_utils.api.types import PartialObj
from tau_hard.model_utils.model.general_model import GeneralModel
from tau_hard.model_utils.model.model import (
    AnyModel,
    BinaryClassifyModel,
    ClassifyModel,
    GenerateModel,
...
def default_api(
    ...
    from tau_hard.model_utils.model.general_model import default_model
...
def default_api_from_args(args: argparse.Namespace) -> API:
    from tau_hard.model_utils.model.general_model import model_factory
...
def default_quick_api(
    ...
    from tau_hard.model_utils.model.general_model import default_quick_model
